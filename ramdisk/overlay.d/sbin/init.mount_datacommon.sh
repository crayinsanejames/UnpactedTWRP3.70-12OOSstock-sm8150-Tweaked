...
mount -t f2fs -o rw,noatime,nosuid,nodev,discard,fsync_mode=nobarrier /dev/block/by-name/userdata2 /datacommon
mount -t ext4 -o rw,noatime,nosuid,nodev,discard,fsync_mode=nobarrier /dev/block/by-name/userdata2 /datacommon
